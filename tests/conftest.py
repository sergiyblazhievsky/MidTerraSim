...
TEST_ENTITIES = {
    "items": [
        ...
        {"name": "carrot", "tags": ["raw", "food", "vegetable"], "hunger_gain": 2,
         "texture": "textures/carrot_16.png"},
        {"name": "cabbage", "tags": ["raw", "food", "vegetable"], "hunger_gain": 3,
         "texture": "textures/cabbage_16.png"},
    ...
    "creatures": [
        ...
        },
        {
            "name": "rabbit",
            "tags": ["fauna", "small"],
            "texture": "textures/rabbit_sniffing.png",
            "sleep_texture": "textures/rabbit_sleeping.png",
            "count": 2,
            "scale": [1.0, 1.0],
            "y_offset": 1.0,
            "move_interval_day": 3.0,
